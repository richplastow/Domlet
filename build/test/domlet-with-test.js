...
var Domlet, Node, Tudor, tudor, xx, ª, ªA, ªB, ªC, ªE, ªF, ªN, ªO, ªR, ªS, ªU, ªV, ªX, ªex, ªhas, ªinsert, ªis, ªisU, ªredefine, ªtype, ªuid,
...
tudor.add([
  "01 Domlet Constructor Usage", tudor.is, "The class and instance are expected types", "The Domlet class is a function", ªF, function() {
    return Domlet;
